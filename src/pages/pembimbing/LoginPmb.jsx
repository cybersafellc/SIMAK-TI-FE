...
import { adminLogin, mahasiswaLogin, pembimbingLogin } from "../../utils/auth";

export default function LoginPmb() {
  ...
  const handleLogin = async (e) => {
    ...
    await pembimbingLogin(
      ...
      (err, data) => {
        ...
        localStorage.setItem("pmb_token", data.access_token);
        window.location.href = "/pembimbings";
        return;
      }
    );
  };
  ...
  useEffect(() => {
    const access_token = localStorage.getItem("pmb_token");
    if (access_token) window.location.href = "/pembimbings";
  }, []);
  return (
    <>
      <Message
