...
export default function SeminarHasilDetails() {
  ...
  const [nilaiPembimbing2, setNilaiPembimbing2] = React.useState("");
  const changeNilaiPembimbing2 = ({ target }) =>
    setNilaiPembimbing2(target.value);
  ...
  const penilaian = async (e) => {
    ...
    try {
      ...
      const form = {
        ...
        nilai_pembimbing_dua: nilaiPembimbing2,
      };
      const [data] = await Promise.all([
        new Promise((resolve, reject) => {
          SeminarHasilPenilaian(form, accessToken, (err, data) => {
            if (err) reject(err);
            else resolve(data);
          });
        }),
  ...
  const setujui = async (e) => {
    ...
    try {
      ...
      const [data] = await Promise.all([
        new Promise((resolve, reject) => {
          SeminarHasilDisetujui(form, accessToken, (err, data) => {
            if (err) reject(err);
            else resolve(data);
          });
        }),
    ...
    const fetchData = async () => {
      try {
        ...
        const [kpData] = await Promise.all([
          new Promise((resolve, reject) => {
            getSeminarHasilID(query.get("id"), accessToken, (err, data) => {
              if (err) reject(err);
              else resolve(data);
            });
          }),
        ...
        if (
          err.message ==
          `seminar hasil dengan id:${query.get("id")} tidak ditemukan`
        ) {
          alert(err);
          window.location.href = "/kordinators/seminar-hasil";
              ...
              <div className="container">
                <div className="row">
                  <div className="col-12">
                    <h1 className="h4">Details Pengajuan Seminar Hasil</h1>
                    <nav aria-label="breadcrumb">
                      <ol className="breadcrumb m-0 fs-7">
                        ...
                        <li className="breadcrumb-item">Seminar Hasil</li>
                        <li
                          ...
                          <div className="card-body">
                            <ul className="list-group list-group-flush mb-0">
                              <li className="list-group-item">
                                ...
                                <span>
                                  {kp?.details_seminar?.judul_penelitian || "-"}
                                </span>
                              </li>
                              <li className="list-group-item">
                              ...
                              <li className="list-group-item">
                                ...
                                <span>
                                  {kp?.details_seminar?.pembimbing_dua?.nama ||
                                    "-"}
                                </span>
                              </li>
                            </ul>
                        ...
                        >
                          ...
                          >
                            ...
                            <div className="row g-0">
                              ...
                              <div className="col-7 col-md-9 bg-light border-start border-bottom border-white border-3">
                                <div className="p-2">
                                  {kp?.penilaian?.nilai_semhas || "-"}
                                </div>
                              </div>
                              <div className="col-5 col-md-3 bg-light border-bottom border-white border-3">
                                <div className="p-2">Nilai Komprehensif</div>
                              </div>
                              <div className="col-7 col-md-9 bg-light border-start border-bottom border-white border-3">
                                <div className="p-2">
                                  {kp?.penilaian?.nilai_sidang_komprehensif ||
                                    "-"}
                                </div>
                              </div>
                              <div className="col-5 col-md-3 bg-light border-bottom border-white border-3">
                              ...
                              <div className="col-7 col-md-9 bg-light border-start border-bottom border-white border-3">
                                <div className="p-2">
                                  {kp?.penilaian?.nilai_pembimbing_satu || "-"}
                                </div>
                              </div>
                              <div className="col-5 col-md-3 bg-light border-bottom border-white border-3">
                                <div className="p-2">Nilai Pembimbing 2</div>
                              </div>

                              <div className="col-7 col-md-9 bg-light border-start border-bottom border-white border-3">
                                <div className="p-2">
                                  {kp?.penilaian?.niali_pembimbing_dua || "-"}
                                </div>
                              </div>
                                ...
                                <div className="row gy-3 gy-xxl-4">
                                  ...
                                  <div className="col-12">
                                    ...
                                    <input
                                      ...
                                      className="form-control"
                                      id="newPassword"
                                      value={nilaiPembimbing2}
                                      onChange={changeNilaiPembimbing2}
                                    />
                                  </div>
