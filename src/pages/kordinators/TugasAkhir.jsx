...
export default function TugasAkhir() {
  ...
  const navigateIncrement = () => {
    window.location.href =
      "/kordinators/tugas-akhir?page=" + (parseInt(page) + 1);
  };
              ...
              <div className="container">
                <div className="row">
                  <div className="col-12">
                    <h1 className="h4">Pengajuan Tugas Akhir</h1>
                    ...
                    <div className="card widget-card border-light shadow-sm h-100">
                      <div className="card-body p-4">
                        ...
                        <div>
                          ...
                          >
                            <Form.Label>Cari Pengajuan TA</Form.Label>
                            <Form.Control
                              type="text"
                              placeholder="Nama"
                              value={search}
                            ...
                            <Form.Text className="text-muted text-capitalize">
                              Untuk Mencari Informasi TA, Silahkan Masukkan nama
                              Mahasiswa
                            </Form.Text>
                          </Form.Group>
                        </div>
