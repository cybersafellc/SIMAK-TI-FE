...
export default function SeminarHasil() {
  ...
  const navigateIncrement = () => {
    window.location.href =
      "/kordinators/seminar-hasil?page=" + (parseInt(page) + 1);
  };
    ...
    try {
      ...
      const [mahasiswa] = await Promise.all([
        new Promise((resolve, reject) => {
          getSeminarHasilSearch(target.value, accessToken, (err, data) => {
            if (err) reject(err);
            else resolve(data);
          });
        }),
  ...
  const handleDetails = async (id) => {
    window.location.href = `/kordinators/seminar-hasil/details?id=${id}`;
    return;
  };
              ...
              <div className="container">
                <div className="row">
                  <div className="col-12">
                    <h1 className="h4">Pengajuan Seminar Hasil</h1>
                    ...
                    <div className="card widget-card border-light shadow-sm h-100">
                      <div className="card-body p-4">
                        <h5 className="card-title widget-card-title mb-4">
                          List Mahasiswa Mengajukan Seminar Hasil
                        </h5>
                        <div>
                          <Form.Group
                            className="mb-3"
                          ...
                          >
                            ...
                            <Form.Text className="text-muted text-capitalize">
                              Untuk Mencari Informasi Seminar Hasil, Silahkan
