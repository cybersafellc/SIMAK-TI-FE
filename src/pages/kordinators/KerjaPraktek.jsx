...
export default function KerjaPraktek() {
  ...
  const navigateIncrement = () => {
    window.location.href =
      "/kordinators/kerja-praktek?page=" + (parseInt(page) + 1);
  };
              ...
              <div className="container">
                <div className="row">
                  <div className="col-12">
                    <h1 className="h4">Pengajuan Kerja Praktek</h1>
                    ...
                    <div className="card widget-card border-light shadow-sm h-100">
                      <div className="card-body p-4">
                        ...
                        <div>
                          ...
                          >
                            <Form.Label>Cari Pengajuan KP</Form.Label>
                            <Form.Control
                              type="text"
                              placeholder="Nama"
                              value={search}
                            ...
                            <Form.Text className="text-muted text-capitalize">
                              Untuk Mencari Informasi KP, Silahkan Masukkan nama
                              Mahasiswa
                            </Form.Text>
                          </Form.Group>
                        </div>
