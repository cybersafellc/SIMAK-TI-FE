...
export default function SeminarProposalDetails() {
    ...
    try {
      ...
      const [data] = await Promise.all([
        new Promise((resolve, reject) => {
          SeminarProposalPenilaian(form, accessToken, (err, data) => {
            if (err) reject(err);
            else resolve(data);
          });
        }),
  ...
  const setujui = async (e) => {
    ...
    try {
      ...
      const [data] = await Promise.all([
        new Promise((resolve, reject) => {
          SeminarProposalDisetujui(form, accessToken, (err, data) => {
            if (err) reject(err);
            else resolve(data);
          });
        }),
    ...
    const fetchData = async () => {
      try {
        ...
        const [kpData] = await Promise.all([
          new Promise((resolve, reject) => {
            getSeminarProposalID(query.get("id"), accessToken, (err, data) => {
              if (err) reject(err);
              else resolve(data);
            });
          }),
        ...
        if (
          err.message ==
          `seminar proposal dengan id:${query.get("id")} tidak ditemukan`
        ) {
          alert(err);
          window.location.href = "/kordinators/seminar-proposal";
              ...
              <div className="container">
                <div className="row">
                  <div className="col-12">
                    <h1 className="h4">Details Pengajuan Seminar Proposal</h1>
                    <nav aria-label="breadcrumb">
                      <ol className="breadcrumb m-0 fs-7">
                        ...
                        <li className="breadcrumb-item">Seminar Proposal</li>
                        <li
                      ...
                      <div className="card-body p-4">
                        ...
                        >
                          <div
                            ...
                            tabIndex={0}
                          >
                            <h5 className="mb-3">Data Seminar Proposal</h5>
