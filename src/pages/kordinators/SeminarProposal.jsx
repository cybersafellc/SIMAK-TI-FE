...
export default function SeminarProposal() {
  ...
  const navigateIncrement = () => {
    window.location.href =
      "/kordinators/seminar-proposal?page=" + (parseInt(page) + 1);
  };
    ...
    try {
      ...
      const [mahasiswa] = await Promise.all([
        new Promise((resolve, reject) => {
          getSeminarProposalSearch(target.value, accessToken, (err, data) => {
            if (err) reject(err);
            else resolve(data);
          });
        }),
  ...
  const handleDetails = async (id) => {
    window.location.href = `/kordinators/seminar-proposal/details?id=${id}`;
    return;
  };
              ...
              <div className="container">
                <div className="row">
                  <div className="col-12">
                    <h1 className="h4">Pengajuan Seminar Proposal</h1>
                    ...
                    <div className="card widget-card border-light shadow-sm h-100">
                      <div className="card-body p-4">
                        <h5 className="card-title widget-card-title mb-4">
                          List Mahasiswa Mengajukan Seminar Proposal
                        </h5>
                        <div>
                          <Form.Group
                            className="mb-3"
                          ...
                          >
                            <Form.Label>
                              Cari Pengajuan Seminar Proposal
                            </Form.Label>
                            <Form.Control
                              type="text"
                              placeholder="Nama"
                            ...
                            <Form.Text className="text-muted text-capitalize">
                              Untuk Mencari Informasi Seminar Proposal, Silahkan
