...
export default function SeminarProposalMhs() {
    ...
    try {
      ...
      const [data] = await Promise.all([
        new Promise((resolve, reject) => {
          pengajuanSeminarProposal(form, accessToken, (err, data) => {
            if (err) reject(err);
            else resolve(data);
          });
        }),
    ...
    const fetchData = async () => {
      try {
        ...
        const [mahasiswaProfile, seminarKp] = await Promise.all([
          ...
          new Promise((resolve, reject) => {
            getSeminarProposal(1, accessToken, (err, data) => {
              ...
              <div className="container">
                <div className="row">
                  <div className="col-12">
                    <h1 className="h4">Seminar Proposal</h1>
                            ...
                            detailTa?.status !== "ditolak" ? (
                              <>
                                ...
                                <div className="row g-0">
                                  ...
                                  <div className="col-7 col-md-9 bg-light border-start border-bottom border-white border-3">
                                    <div className="p-2">
                                      {detailTa?.penilaian?.nilai_sempro || "-"}
                                    </div>
                                  </div>
                                  <div className="col-5 col-md-3 bg-light border-bottom border-white border-3">
                                    <div className="p-2">
