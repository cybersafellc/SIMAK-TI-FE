...
export default function SeminarKpMhs() {
    ...
    try {
      ...
      const [data] = await Promise.all([
        new Promise((resolve, reject) => {
          pengajuanSeminarKp(form, accessToken, (err, data) => {
            if (err) reject(err);
            else resolve(data);
          });
        }),
    ...
    const fetchData = async () => {
      try {
        ...
        const [mahasiswaProfile, seminarKp] = await Promise.all([
          ...
          new Promise((resolve, reject) => {
            getSeminarKP(1, accessToken, (err, data) => {
              ...
              <div className="container">
                <div className="row">
                  <div className="col-12">
                    <h1 className="h4">Seminar Kerja Praktek</h1>
                          ...
                          <div className="card-body">
                            <ul className="list-group list-group-flush mb-0">
                              <li className="list-group-item">
                                ...
                                <span>
                                  {detailTa?.details_seminar?.judul_laporan ||
                                    "-"}
                                </span>
                              </li>
                              <li className="list-group-item">
                            ...
                            detailTa?.status !== "ditolak" ? (
                              <>
                                ...
                                <div className="row g-0">
                                  ...
                                  <div className="col-7 col-md-9 bg-light border-start border-bottom border-white border-3">
                                    <div className="p-2">
                                      {detailTa?.penilaian_seminar_kp?.nilai ||
                                        "-"}
                                    </div>
                                  </div>
                                  <div className="col-5 col-md-3 bg-light border-bottom border-white border-3">
                                ...
                                <div className="row gy-3 gy-xxl-4">
                                  <div className="col-12">
                                    <Alert variant="warning">
                                      ...
                                      <ul>
                                        <li>
                                          Pastikan anda sudah Mengajukan Kerja
                                          Praktek Di Sistem
                                        </li>
                                        <li>
                                          Pastikan kordinator Sudah Menyetujui
                                          Pengajuan Kerja Praktek (KP) anda.
                                        </li>
                                        <li>
                                          Pastikan Pembimbing KP anda sudah meng
                                          set judul laporan anda Di Sistem.
                                        </li>
                                      </ul>
                                    </Alert>
                                  </div>
